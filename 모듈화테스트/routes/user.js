    ...
    if(database.pool) {
        ...
        database.user.adduser(database.pool, data, function(err, added) {
            ...
            if(added) {
                ...
                res.writeHead(200, {'Content-Type':'text/html;charset=utf8'});
                res.write('<div><p>회원가입이 완료 되었습니다.</p></div>');
                ...
                res.write("<br><br><a href = '../public/signup.html'>다시 회원가입하기</a>");
                res.end();
            }
        });
    ...
    if(database.pool) {
        ...
        var usernickname = rows[0].nickname;
            ...
            if(rows.length > 0) {
                ...
                res.write("<br><br><a href = '../public/페이지.html'>메인 페이지 가기</a>");
                res.end();
                ...
                res.write("<br><br><a href = '../public/login.html'>다시 로그이")
            }
        });
